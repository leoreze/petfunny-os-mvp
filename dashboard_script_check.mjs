    ...
    function dashboardStatusMessageModalHtml() {
      return `
        <dialog class="modal-shell agenda-message-modal" id="dashboard-status-message-modal">
          <form method="dialog" class="modal-card agenda-message-modal-card">
            <div class="modal-header">
              <div>
                ...
                <p class="modal-subtitle" id="dashboard-status-message-subtitle">Revise a sugestão antes de abrir no WhatsApp.</p>
              </div>
